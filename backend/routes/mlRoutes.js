...
router.post('/modules/:moduleKey/requests/:requestId/decision', mlController.updateVendorRequestDecision);
...
router.patch('/modules/:moduleKey/:collectionKey/:itemId', mlController.updateModuleDataItem);
